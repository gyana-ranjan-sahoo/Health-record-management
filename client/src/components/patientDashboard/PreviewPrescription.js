...
const PreviewPrescription = (props) => {
  ...
  const handleViewReport = (healthID, report) => {
    window.open(
      `/patient/view_report/${healthID}/${report}`,
      'newwindow',
  ...
  return (
    <div
      className='body min-h-screen col-span-10 font-poppins   overflow-y-scroll scroll-m-0'
      id='prescription'
    >
