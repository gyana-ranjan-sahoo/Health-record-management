...
import upload_img from '../../assets/img/dashboard/upload.png';
        ...
        <nav>
          ...
          <div className='p-4'>
            ...
            <div className='grid grid-rows-2 gap-4 font-bold font-poppins mt-4'>
              <Link
                to='/patient/upload'
                onClick={() => setToggle('Upload_reports')}
                className={
                  Toggle === 'Upload_reports'
                    ? 'text-gray-900 '
                    : 'text-gray-400'
                }
              >
                <div className='flex p-2'>
                  <img src={upload_img} className='w-6' alt='history'></img>
                  <h1 className='ml-4'>Upload Reports</h1>
                </div>
              </Link>
              <Link
                to='/patient/history'
