      ...
      <div className='bg-secoundry w-full'>
        <div className=''>
          <div className=' flex justify-center mt-4'>
            <h1 className='  p-2 px-8 rounded font-bold text-5xl'>
          ...
          >
            ...
            <div className={Toggle === 'Patient' ? '' : 'hidden'}>
              <div className='lg:grid lg:grid-cols-4 lg:gap-2 mt-4 mr-4 grid grid-cols-4 gap-2'>
                ...
                <div>
                  <input
                    className='bg-red-100 rounded lg:h-10 lg:pl-4 mt-4 lg:text-md text-sm h-8 px-2'
                    required
              ...
              <div className='lg:grid grid-cols-4 gap-2 mt-4 mr-4'>
                ...
                <input
                  type='date'
                  className=' bg-red-100 lg:h-10 rounded pl-4 h-8'
                  required
                  value={patient.dob}
                  onChange={(e) => {
                    let temppatient = { ...patient };
              ...
              <div className='lg:grid grid-cols-4 gap-2 mt-4 mr-4'>
                ...
                <input
                  ...
                  required
                  className='pl-4 bg-red-100 lg:h-10  rounded h-8'
              ...
              <div className='grid grid-cols-4 gap-2 mt-4 mr-4'>
                ...
                <input
                  ...
                  required
                  className='bg-red-100 lg:h-10 rounded pl-4 col-span-2 h-8'
                  value={patient.email}
                  onChange={(e) => {
                    let temppatient = { ...patient };
              ...
              <div className='grid grid-cols-4 gap-2 mt-4 mr-4'>
                ...
                <div className=''>
                  <select
                    className='pl-4 lg:w-1/2 bg-red-100 lg:h-10  rounded  h-8'
                    id='blood-group'
              ...
              <div className='lg:grid lg:grid-cols-4 gap-2 mt-4 mr-4 flex'>
                ...
                <input
                  type='password'
                  id='password'
                  className='bg-red-100 lg:h-10  rounded lg:pl-4 h-8 pl-2'
                  required
                ...
                <div className='col-span-4'>
                  {diseaseList.map((disease, index) => {
                    return (
                      ...
                      >
                        <input
                          className='bg-red-100 lg:h-10 col-span-3 rounded lg:pl-4 h-8 pl-2'
                          type='text'
                          name='disease'
                        ...
                        />
                        <input
                          className='bg-red-100 lg:h-10 col-span-3  rounded lg:pl-4 h-8 pl-2 ml-4'
                          type='text'
                          name='yrs'
            ...
            <div className={Toggle === 'Patient' ? '' : 'hidden'}>
              ...
              <div className='lg:grid grid-cols-4 gap-2 mt-8 mr-4 flex'>
                ...
                <input
                  className='bg-red-100 rounded h-10 pl-4'
                  placeholder='first name'
              ...
              <div className='mt-4'>
                ...
                <input
                  className='bg-red-100 lg:h-10 ml-24 rounded pl-4 h-8 lg:mt-0 lg:ml-0 mt-2 '
              ...
              <div className='grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense '>
                ...
                <div className='grid grid-cols-2 gap-8 col-span-3 '>
                  <input
                    type='text'
                    className='bg-red-100 h-10  rounded pl-4 '
                    required
                    placeholder='building/area'
